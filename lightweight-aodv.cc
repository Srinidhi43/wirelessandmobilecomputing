...
int main(int argc, char *argv[])
{
    ...
    /* ---------------- NETANIM ---------------- */
    AnimationInterface anim("secure-aodv.xml");
    ...
    /* ---------------- OUTPUT ---------------- */
    std::cout << "\n===== LIGHTWEIGHT SECURITY AODV RESULTS =====\n";
    std::cout << "Packets Sent = " << tx << "\n";
    std::cout << "Packets Received = " << rx << "\n";
    std::cout << "Packet Loss = " << lost << "\n";
    std::cout << "PDR = " << pdr << " %\n";
    std::cout << "Delay = " << avgDelay << " sec\n";
    std::cout << "Throughput = " << throughput << " Kbps\n";
    std::cout << "Authentication Failures = " << authFailCount << "\n";
    std::cout << "Security Overhead = " << (0.003 * tx) << " sec\n";
